...
for number in $pr_numbers; do
  ...
  curl -s --fail -H "Accept: application/vnd.github.v3+json" "https://api.github.com/repos/argoproj/argo-cd/pulls/$number/files?per_page=100" -H "Authorization: Bearer $token" \
